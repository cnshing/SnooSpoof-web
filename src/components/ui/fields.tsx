...
export function Input(
    ...
    */
    ...
    return (
        <input className={styles.input_text} value={value} {...passthrough} onChange={changeValue}/>
    )
}
...
export function Textarea(
    { initialValue = "", composeValue = (value) => value, children, ...passthrough }:
        ...
        => TextAreaValue, 
        children?: React.ReactNode } & TextArea
) {
    ...
    return (
        <textarea className={styles.input_text} value={value} {...passthrough} onChange={changeValue}></textarea>
    )
}
 ...
 */
 export function Checkbox(
    { initialChecked = false, composeChecked = (checked) => checked , label, labelSize = "16px", checkboxSize = "19px", ...passthrough }:
        ...
        => InputChecked, 
        label?: string, labelSize?:string, checkboxSize?: string } & Input
) {
    const sizing = {
